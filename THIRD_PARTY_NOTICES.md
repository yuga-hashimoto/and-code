...
|---|---|---|---|---|
| `proot` | 5.1.107.90 | [GPL-2.0](THIRD_PARTY_LICENSES/GPL-2.0.txt), per [`TERMUX_PKG_LICENSE`](runtime_tools/termux-packaging-recipes/proot.build.sh) | The PRoot contributors | Upstream source archive `v5.1.107.90.zip`, SHA-256 `b7e4da1ed53fa4c1fa8dc3645f91f9d95ccfc559a1c5f68d084f93d8f0670a25` (from [github.com/termux/proot](https://github.com/termux/proot/archive/v5.1.107.90.zip), tagged release, not `master`) |
