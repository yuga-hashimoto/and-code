...
|---|---|---|---|---|
| `proot` | 5.1.107.91 | [GPL-2.0](THIRD_PARTY_LICENSES/GPL-2.0.txt), per [`TERMUX_PKG_LICENSE`](runtime_tools/termux-packaging-recipes/proot.build.sh) | The PRoot contributors | Upstream source archive `v5.1.107.91.zip`, SHA-256 `a7bc2fab34bf9a39073e8291f08a662e848c61a67494e59f5f84f5ca10690128` (from [github.com/termux/proot](https://github.com/termux/proot/archive/v5.1.107.91.zip), tagged release, not `master`) |
